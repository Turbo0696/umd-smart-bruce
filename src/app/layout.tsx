...
import { EMBED_HEADER } from "@/lib/embed";
import "./globals.css";
...
export default async function RootLayout({ children }: LayoutProps<"/">) {
  ...
  // Embedded (e.g. in a Canvas iframe via `?embed=1`): no nav or footer, so
  // there's nowhere to navigate to from inside the frame.
  const embed = requestHeaders.get(EMBED_HEADER) === "1";
